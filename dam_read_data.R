...
p <- as.data.frame(dt2) %>%
    ...
    layout(
      ...
      , annotations = list(
        x = c(0.01)
        , y = c(0.97, seq(0.90, 0.84, by = -0.02), seq(0.66, 0.62, by = -0.02))
        , text = c(
          "Dams around the World -- Artistic Response for Climate Change 2"
          , "Wu Gong"
          , "Prof. Diane L. Moore"
          , "GOVT E-596"
          , "October 29th, 2019"
...
main_text <- c(
    "This is an interactive map of the 7320 dams around the"
  , "<a href = 'https://plot.ly/r/'>world built until 2017. The data come from</a>"
