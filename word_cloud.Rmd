 ...
 * This is a word cloud for the text of [WMA Declaration of Helsinki - Ethical Principles for Medical Research Involving Human Subjects](https://www.wma.net/policies-post/wma-declaration-of-helsinki-ethical-principles-for-medical-research-involving-human-subjects/)
...
plt_wd <- function(txt){
    ...
    tok <- function(x) NGramTokenizer(x, Weka_control(min=1, max=3))
    tdm <- TermDocumentMatrix(txt
                            , control = list(tokenize = tok
